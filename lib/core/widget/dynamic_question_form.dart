...
if(sl<AppStateModel>().shouldUpdateWidget!=null &&sl<AppStateModel>().shouldUpdateWidget==true ){
             ...
             data: Theme.of(context).copyWith(
               ...
               textButtonTheme: TextButtonThemeData(
                 style: TextButton.styleFrom(
                   foregroundColor:Styles.colorPrimary, // Button text color
                 ),
               ),
             ),
             child: child!,
...
initialValue: field.values,
        ...
        case 'select':
          ...
          if(field.options!.contains('family')){
            ...
            for(int i=0;i<   familyGroupField!.groupedFields.length;i++){
              ...
              GroupedField groupedField=familyGroupField.groupedFields[
                familyGroupField.groups[i]??'']!.where((e)=>
      e.name=='الاسم الشخصي'
      ).first  ;
      field.optionsList!.add(
      groupedField.values??'' );
            }
            }
              ...
              return [
                ...
                Container(
                  // height: 56.h,
                    ...
                    //   field.optionsList!.first:
                    //   field.optionsList![selectedIndex],
      ...
      setState(() {
        ...
        int indexed=listdataShown.indexWhere((e)=>e.id==field.id);
            String valueSeleected=(field.optionsList ?? [])[_currentIndex];
...
if(_formData[field.name ?? '']==''){
  ...
  int indexed=listdataShown.indexWhere((e)=>e.id==field.id);
  CountryModel?  value=
  countryOption!.where((e)=>e.name==_formData[field.name ?? '']).first
  ...
  selectedIndex=0;
  selectedIndex=countryOption.indexWhere((e)=>e!.name==value!.name);
             ...
             return [
              ...
              Container(
                ...
                DropdownButtonFormField<CountryModel>(
                  ...
                  items: (countryOption ?? [])
                      .map((option) =>
                      DropdownMenuItem(value: option, child:
      ...
      height: 20.w,
            ...
            //    field.options=
            //    field.options.toString().contains(',')?field.options:field.options.toString()+'،';
            // }
             field.optionsList= field.options!=null?field.options.toString().split('،'):[];
...
showCheckmark: false,
              ...
              if(field.optionsList!.first.contains(')')){
                ...
                for (String segment in field.optionsList??[]) {
                  ...
                  if (insideMatch != null) textInsideUnderThelist.add(
                      insideMatch.group(1) ?? '');
                  ...
                  if (outsideMatch != null) textInsideThelist.add(
                      outsideMatch.group(1)!.trim() ?? '');
                }
                int index=-1;
                for(int i=0 ;i<textInsideThelist.length;i++){
                  if( (_formData[field.name ?? '']).toString().contains( textInsideThelist[i])){
                    index=i;
                  }
                }
                // index=textInsideThelist!.indexOf(  _formData[field.name ?? ''] );
                return [
                  CustomText(
                    text: field.name ?? '',
                    style: Styles.w400TextStyle()
                  ...
                  Container(
                    // height: 56.h,
                      ...
                      // DropdownButtonFormField<String>(
                      //   value: index==-1?
                      //   textInsideThelist!.first:
                      //   textInsideThelist[index],
                      //   decoration: InputDecoration(labelText: '',
                      //       contentPadding: EdgeInsets.symmetric(vertical: 0,horizontal: 20.w),
                      //       border:OutlineInputBorder(
                      //         borderRadius: BorderRadius.all(Radius.circular(8.r)), )),
                      //   items: (textInsideThelist ?? [])
                      //       .map((option) =>
                      //       DropdownMenuItem(value: option, child: Text(option)))
                      //       .toList(),
                      //   onChanged: (value) {
...
showCheckmark: false,
                  ...
                  CustomText(
                    text:
                    index==-1?
                    textInsideUnderThelist!.first:textInsideUnderThelist[index] ,
        ...
        case 'checkbox':
          ...
          if(_formData[field.name ?? ''] ==null|| _formData[field.name ?? ''] =='') {
            ...
            lst.add(
              Expanded(child: CheckboxListTile(
                ...
                value:    _formData[field.name ?? ''].toString()
                    .compareTo(field.optionsList![i] )==0,
                onChanged: (value) {
                  int indexed=listdataShown.indexWhere((e)=>e.id==field.id);
...
saveFile(GroupedField field,File? _selectedFile) async{
  ...
  if(_selectedFile!=null) {
    ...
    _selectedListFile.addAll({field.id:FilesModelData(
