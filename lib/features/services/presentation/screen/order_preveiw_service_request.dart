...
class _ContinuationServiceRequestState
    extends State<OrderPreveiwServiceRequestScreen> {
  ...
  List<Widget> getSortInfo() {
    ...
    try {
      ...
      for (int i = 0; i < keys.length; i++) {
        ...
        lstWidget.add(CommonSizes.vBigSpace);
        ...
        lstWidget.add(CommonSizes.vSmallSpace);
        lstWidget.add(
            // Expanded(child:
  ...
  Widget buildGroup(List<InfoData> infoListTmp) {
    try {
      return DynamicInfoQuestionFormPage(
